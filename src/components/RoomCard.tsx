...
const IMAGEN_FALLBACK: Record<string, string> = {
  ...
  COMPARTIDA: "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=800&q=80",
  DORMITORIO: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=800&q=80",
