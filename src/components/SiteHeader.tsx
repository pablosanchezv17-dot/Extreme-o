    ...
    <header className="absolute top-0 left-0 right-0 z-20">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        ...
        <nav className="hidden md:flex items-center gap-1">
          <Link href="/#habitaciones" className="font-body text-sm font-medium text-white/90 hover:text-white px-3 py-2 rounded-lg hover:bg-white/10 transition-all">Habitaciones</Link>
          <Link href="/#galeria" className="font-body text-sm font-medium text-white/90 hover:text-white px-3 py-2 rounded-lg hover:bg-white/10 transition-all">Galería</Link>
          <Link href="/resenas" className="font-body text-sm font-medium text-white/90 hover:text-white px-3 py-2 rounded-lg hover:bg-white/10 transition-all">Reseñas</Link>
          <Link href="/contacto" className="font-body text-sm font-medium text-white/90 hover:text-white px-3 py-2 rounded-lg hover:bg-white/10 transition-all">Contacto</Link>
        </nav>
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
          <div className="col-span-2 sm:col-span-1">
            <div className="flex items-center gap-3 mb-3">
              <Image src="/logo.png" alt="Hostal Azahar" width={56} height={56} className="rounded-full" />
